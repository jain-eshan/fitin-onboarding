...
export default function StepLayout({
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#FAFAF5]">
        ...
        <div className="flex w-8 items-center">
          {showBack && (
            <button
              onClick={onBack}
              aria-label="Go back"
              className="flex h-8 w-8 items-center justify-center rounded-full text-[#8A8577] hover:bg-[#EDEADE] hover:text-[#53603E] transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-[#53603E]"
            >
      ...
      <main className="flex flex-1 flex-col items-center px-5 pt-6 pb-10">

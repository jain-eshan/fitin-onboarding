  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      ...
      <div className="flex flex-col gap-3">
        <h1
          className="text-[28px] font-semibold tracking-[-0.02em] text-[#2D2D2A] leading-[1.2]"
          style={{ fontFamily: 'var(--font-heading)' }}
        >
          Find your fitness style in 2 minutes.
        </h1>
        <p className="text-[14px] text-[#8A8577] leading-relaxed">
          Answer 8 quick questions about your lifestyle and goals. We'll build a personalised fitness profile and connect you with a trainer who gets it.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2.5">
        {[
          ...
          <div key={item.text} className="flex items-start gap-2.5">
            ...
            <p className="text-[13px] text-[#2D2D2A]">{item.text}</p>
          </div>
        ))}
      </div>
